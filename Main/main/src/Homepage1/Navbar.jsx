...
<div className='row'></div>
    ...
    <div className='row2'>  
      ...
      <div className='box1'>
           <Link to='/not' className='Linkcss'>Brands</Link>
      </div>
      <Link to="/not" className='Linkcss'>Browse By</Link>
      <Link to="/some" className='Linkcss'>BestSellers</Link>
    ...
    <div className='row3'>
        ...
        <div>
        <Link to="some" className='Linkcss'>
    ...
    <div className='para'>
        <Link to="something" className='Linkcss1'>
